...
const TableSelection: React.FC = () => {
  ...
  return (
    <div className="text-center">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-white mb-2">ยินดีต้อนรับ!</h1>
      <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">กรุณาเลือกหมายเลขโต๊ะของคุณเพื่อเริ่มต้น</p>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
        {Array.from({ length: TOTAL_TABLES }, (_, i) => i + 1).map((tableId) => (
          ...
          >
            <span className="text-sm text-gray-500 dark:text-gray-400">โต๊ะ</span>
